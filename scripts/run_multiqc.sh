...
multiqc ${WDIR}/data_output/somatic_variant_calling/QC/1_For_MultiQC/ --outdir ${WDIR}/data_output/somatic_variant_calling/ --force --title "Quality Control - After alignment" --comment "Reads were aligned against hg38 human reference sequence (release 109)." --config /mnt/beegfs/scratch/bioinfo_core/B24018_OLBE_01/script/somatic_variant_calling/multiqc_config2.yaml
